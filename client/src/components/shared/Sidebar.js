...
class Sidebar extends Component {
  ...
  onRouteChanged() {
    ...
    const dropdownPaths = [
      { path: '/organismes', state: 'organismeMenuOpen' },
      { path: '/employes', state: 'employesMenuOpen' },
      { path: '/salles', state: 'sallesMenuOpen' },
      { path: '/ressources', state: 'ressourcesMenuOpen' },
      { path: '/categories', state: 'categoriesMenuOpen' },
      { path: '/reservations', state: 'reservationsMenuOpen' },
    ]
    ...
    return (
      <nav className='sidebar sidebar-offcanvas' id='sidebar'>
        <ul className='nav'>
          ...
          <li className='nav-item nav-category'>Organismes / Employés</li>
          <li className={this.isPathActive('/organismes') ? 'nav-item active' : 'nav-item'}>
            <div
              className={this.state.organismeMenuOpen ? 'nav-link menu-expanded' : ' nav-link'}
              onClick={() => this.toggleMenuState('organismeMenuOpen')}
              data-toggle='collapse'
            >
              <span className='icon-bg'>
                <i className='mdi mdi-domain menu-icon'></i>
              </span>
              <span className='menu-title'>Organismes</span>
              <i className='menu-arrow'></i>
            </div>
            <Collapse in={this.state.organismeMenuOpen}>
              <ul className='nav flex-column sub-menu'>
                <li className='nav-item'>
                  <Link
                    className={
                      this.isPathActive('/organismes/liste') ? 'nav-link active' : 'nav-link'
                    }
                    to='/organismes/liste'
                  >
            ...
            <Collapse in={this.state.organismeMenuOpen}>
              <ul className='nav flex-column sub-menu'>
                <li className='nav-item'>
                  <Link
                    className={
                      this.isPathActive('/organismes/ajouter') ? 'nav-link active' : 'nav-link'
                    }
                    to='/organismes/ajouter'
                  >
                    Ajouter une organisme
                  </Link>
                </li>
              </ul>
            </Collapse>
          ...
          <li className={this.isPathActive('/demandes') ? 'nav-item active' : 'nav-item'}>
            <Link className='nav-link' to='/demandes'>
              <span className='icon-bg'>
                <i className='mdi mdi mdi-account-plus menu-icon'></i>
              </span>
              <span className='menu-title'>Demandes d'inscription</span>
            </Link>
          </li>
          ...
          <li className={this.isPathActive('/categories') ? 'nav-item active' : 'nav-item'}>
            <div
              className={this.state.categoriesMenuOpen ? 'nav-link menu-expanded' : 'nav-link'}
              onClick={() => this.toggleMenuState('categoriesMenuOpen')}
              data-toggle='collapse'
            >
              <span className='icon-bg'>
                <i className='mdi mdi-format-list-bulleted menu-icon'></i>
              </span>
              <span className='menu-title'> Catégories de ressources </span>
              <i className='menu-arrow'></i>
            </div>
            <Collapse in={this.state.categoriesMenuOpen}>
              <ul className='nav flex-column sub-menu'>
                <li className='nav-item'>
                  ...
                  <Link
                    className={
                      this.isPathActive('/categories/liste') ? 'nav-link active' : 'nav-link'
                    }
                    to='/categories/liste'
                  >
            ...
            <Collapse in={this.state.categoriesMenuOpen}>
              <ul className='nav flex-column sub-menu'>
                <li className='nav-item'>
                  ...
                  <Link
                    className={
                      this.isPathActive('/categories/ajouter') ? 'nav-link active' : 'nav-link'
                    }
